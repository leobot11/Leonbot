...
MSG_ON = """
✅ **Leonardo-Ubot Activated.**
**🏷️ Userbot Version -** `{}`
**Ketik** `.leon` **untuk Mengecheck Bot**
"""
...
async def main():
    ...
    LOGGER("Leonardo").info(f"Leonardo-Ubot v{BOT_VER} ⚙️[⚡ Activated ⚡]")
...
if __name__ == "__main__":
    LOGGER("Leonardo").info("Starting Cilik-Ubot")
    install()
    git()
    heroku()
